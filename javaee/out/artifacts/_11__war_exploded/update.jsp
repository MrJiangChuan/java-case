    ...
    <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
        ...
        <div class="form-group">
            ...
            <select name="address" id="address" class="form-control">
                <c:choose>
                    <c:when test="${'陕西'.equals(user.address)}">
                    ...
                    <c:when test="${'北京'.equals(user.address)}">
                    ...
                    <c:when test="${'上海'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                    ...
                    <c:when test="${'山西'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                    ...
                    <c:when test="${'天津'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'河北'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'河南'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'湖北'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'湖南'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'黑龙江'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'吉林'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'辽宁'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'青海'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'西藏'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'四川'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'重庆'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'宁夏'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'甘肃'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'新疆'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'内蒙古'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'江苏'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'浙江'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'海南'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'福建'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'广东'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'广西'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'贵州'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'云南'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'江西'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'安徽'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'山东'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'香港'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'澳门'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
                    ...
                    <c:when test="${'台湾'.equals(user.address)}">
                        <option value="陕西" >陕西</option>
                        <option value="北京" >北京</option>
                        <option value="上海">上海</option>
                        <option value="山西">山西</option>
